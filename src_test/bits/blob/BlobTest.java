...
public class BlobTest {
    ...
    public void testRecursivePut() {
         ...
         assertNull(b1.get(Blob.class, "d", "d"));
    }
    ...
    public void testRecursiveAdd() {
        ...
        assertNull(b1.get(Blob.class, 0));
        assertNull(b1.get(Blob.class, 0, 0));
    ...
    public void testLoad() {
        ...
        try{
            Blob b = Blob.loadFromYaml(new File("lib/snakeyaml/src/test/resources/specification/example2_3.yaml"));
            System.out.println(b);
            System.out.println(b.toYamlString());
